...
///
- (nonnull instancetype)init:(AKNode * _Nullable)input preGain:(double)preGain postGain:(double)postGain lowGain:(double)lowGain midGain:(double)midGain highGain:(double)highGain distType:(double)distType distortion:(double)distortion OBJC_DESIGNATED_INITIALIZER;
/// Function to start, play, or activate the node, all do the same thing
- (void)start;
/// Function to stop or bypass the node, both are equivalent
- (void)stop;
...
/// Audio player that loads a sample into memory
SWIFT_CLASS("_TtC8AudioKit14AKSamplePlayer") SWIFT_DEPRECATED_MSG("AKSamplePlayer is now AKWaveTable")
...
- (nonnull instancetype)init:(uint8_t)nn :(double)cents OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
- (nonnull instancetype)init:(uint8_t)nn :(NSInteger)pb OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
